...
% BEGIN Heading styles
  ...
  % figure caption
  \setupcaption[figure][number=no, style=\bi\sc, align=center, color=darkgray]
...
% BEGIN ToC Formatting
  ...
  \setuplist[chapter][width=0.1in, style=bold]
  \setuplist[section][width=0.2in, style=bold, margin=0.1in]
  \setuplist[subsection][width=0.3in, margin=0.2in]
  \setuplist[subsubsection][width=0.4in, style=slanted, pagestyle=normal, margin=0.3in]
