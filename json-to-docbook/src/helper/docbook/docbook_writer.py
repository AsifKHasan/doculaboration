...
'''
various utilities for rendering json content into a docbook, mostly for Formatter of type Table
'''
...
def add_section(doc, section_data, section_spec, use_existing=False):
    section = etree.SubElement(doc, 'section')
    title = etree.SubElement(section, 'para')
    title.text = section_data['heading'].strip()
