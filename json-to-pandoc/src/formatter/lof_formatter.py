...
from helper.latex.latex_section import LatexLoFSection
...
def generate(section_data, section_specs, context, section_index, color_dict, last_section_was_landscape):
    ...
    latex_section = LatexLoFSection(section_data, section_spec, section_index, last_section_was_landscape)
