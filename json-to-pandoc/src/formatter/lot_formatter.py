...
from helper.latex.latex_section import LatexLoTSection
...
def generate(section_data, section_specs, context, section_index, color_dict, last_section_was_landscape):
    ...
    latex_section = LatexLoTSection(section_data, section_spec, section_index, last_section_was_landscape)
